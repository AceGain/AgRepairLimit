...
namespace Patch_ItemActionEntryRepair
{
    ...
    public class RefreshEnabled_Patch
    {
        ...
        {
            Patch_BaseItemActionEntry.RefreshEnabled_Patch.ReversePatch(__instance);
        ...
        {
            RefreshEnabled_Patch.Original(__instance);
            return false;
        }
    ...
    public class OnActivated_Patch
    {
        public static void Original(ItemActionEntryRepair __instance)
        {
            XUi xui = __instance.ItemController.xui;
        ...
        public static bool Prefix(ItemActionEntryRepair __instance)
        {
            OnActivated_Patch.Original(__instance);
            return false;
        }
    }
}
