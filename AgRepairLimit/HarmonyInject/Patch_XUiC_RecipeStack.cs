...
namespace HarmonyInject
{
    public class Patch_XUiC_RecipeStack
    {
        ...
        public class Point_SetRepairRecipe
        {
            ...
            {
                __result = Point_SetRepairRecipe.Original(__instance, _repairTimeLeft, _itemToRepair, _amountToRepair, _sourceToolbeltSlot);
                return false;
            }
        }
        ...
        public class Point_HandleOnPress
        {
            ...
            {
                Point_HandleOnPress.Original(__instance, _sender, _mouseButton);
                return false;
            }
        }
    }
